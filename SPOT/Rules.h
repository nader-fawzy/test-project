...
struct Rules	//contains all objects for registrations rules
{
	...
	vector <Course_Code> DoneCourses;  //list of done courses
	...
	int MajorEleCr;
	int NumOfCon;
	int MajorConcen1ComCr;
	int MajorConcen1ElecCr;
	int MajorConcen2ComCr;
	int MajorConcen2ElecCr;
	int MajorConcen3ComCr;
	int MajorConcen3ElecCr;
	...
	vector<Course_Code> MajorConcentrationCompulsory;
	vector<Course_Code> MajorConcentrationElective;
};
